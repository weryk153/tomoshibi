...
- **Frontend source**: `frontend-src/` — a vendored fork of upstream `Open-LLM-VTuber-Web` (tracked directly in this repo, not a submodule; see `frontend-src/UPSTREAM.md` for the pinned upstream commit)
