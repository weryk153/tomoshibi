...
> 免費、開源、新手也能上手，讓你**跟喜歡的動漫角色聊天、互動**的 app。放進 Live2D 或 VRM（3D）模型，角色會依對話自己做表情和動作，說話的語言也能設定，還會記得你、主動找你聊。自備 LLM，其餘開箱即用。
...
**Tomoshibi** 讓你喜歡的角色 —— 手繪的 Live2D 或全 3D 的 VRM —— 真的能跟你聊天、互動：它記得你、會自己開話題、你說話時會聽，說話時還會自己做表情和動作。
