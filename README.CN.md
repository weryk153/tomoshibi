...
> 免费、开源、新手也能上手的 **AI 角色聊天 app**。角色可以是 Live2D 或 VRM（3D），会根据对话自己做表情和动作，说话的语言也能设置，还会记得你、主动找你聊。自带 LLM，其余开箱即用。
...
**Tomoshibi** 让屏幕上的一个角色 —— 手绘的 Live2D 或全 3D 的 VRM —— 真的能跟你聊天：它记得你、会自己开启话题、你说话时会听，说话时还会自己做表情和动作。
