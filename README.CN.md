...
> 一个免费、开源、对新手友好的**桌面 AI 伙伴**，带 Live2D 或 VRM（3D）形象 —— AI 自己驱动表情与动作、可设置表达语言，还有长期记忆与主动聊天。自带你的 LLM，其余一切开箱即用。
...
**Tomoshibi** 把屏幕上的一个角色 —— 手绘的 Live2D 或全 3D 的 VRM —— 变成你真的会去聊天的 AI 伙伴 —— 它记得你、会自己开启对话、你说话时它会听，说话时还会自己做表情和动作。
